        ...
        <div class="page-content">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="feature-banner header-text">
                <div class="row">
                  <div class="col-lg-4">
                    <img src="../../template/assets/images/feature-left.jpg" alt="" style="border-radius: 23px;">
                  </div>
                  <div class="col-lg-8">
                    <div class="thumb">
          ...
          <div class="other-games">
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="item">
                  <img src="../../template/assets/images/game-01.jpg" alt="" class="templatemo-item">
              ...
              <div class="col-lg-6">
                <div class="item">
                  <img src="../../template/assets/images/game-02.jpg" alt="" class="templatemo-item">
                  <h4>Dota 2</h4><span>Sandbox</span>
                  <ul>
                    <li><i class="fa fa-star"></i> 4.8</li>
                    <li><i class="fa fa-download"></i> 2.3M</li>
              ...
              <div class="col-lg-6">
                <div class="item">
                  <img src="../../template/assets/images/game-03.jpg" alt="" class="templatemo-item">
                  <h4>Dota 2</h4><span>Sandbox</span>
                  <ul>
                    <li><i class="fa fa-star"></i> 4.8</li>
                    <li><i class="fa fa-download"></i> 2.3M</li>
